...
def conn_db():
    ...
    try:
        ...
        # excepcion en caso de error, se asigna "None"
        # a la variable conn y se envia mensaje
        conn = None
...
def show_table(conn, table_name):
    '''Funcion para ver contenido de tabla'''
...
#---------------------------------------------------------
# funcion para checar si la tabla existe, si existe el
# resultado es True de lo contrario envia False
def check_table_exist(conn, table_name):
    '''Funcion para checar si la tabla existe'''
...
if __name__ == '__main__':
    ...
    conn = conn_db()
    # asigando el parametro de nombre de tabla y
    # llamando a la funcion crear tabla
    TABLE_NAME = 'delitos'
